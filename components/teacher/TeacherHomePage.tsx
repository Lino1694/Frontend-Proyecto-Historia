...
const TeacherHomePage: React.FC<TeacherHomePageProps> = ({ userName, onLogout, navigateToGamification, navigateToRewardsCenter, navigateToReports, navigateToClassManagement, navigateToContentManagement, navigateToChallenges }) => {
    return (
            ...
            <main className="p-4 space-y-6">
                ...
                <Card className="lg:hidden">
                    <h2 className="text-lg font-bold text-slate-700 mb-3">Herramientas</h2>
                     <div className="grid grid-cols-3 lg:grid-cols-6 gap-3 text-center text-sm font-semibold text-slate-800">
                         ...
                         <ToolButton Icon={SparklesIcon} label="Gamificación" onClick={navigateToGamification} />
